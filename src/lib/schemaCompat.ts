...
const ADD_POST_SOURCE_PULL_REQUEST_ID_SQL = `
ALTER TABLE "Post"
ADD COLUMN IF NOT EXISTS "sourcePullRequestId" TEXT
`;

const ADD_POST_PULL_REQUEST_PROPOSER_ID_SQL = `
ALTER TABLE "Post"
ADD COLUMN IF NOT EXISTS "pullRequestProposerId" TEXT
`;
...
const PROFILE_AND_POST_SCHEMA_SQL = [
    ...
    ADD_POST_SOURCE_PULL_REQUEST_ID_SQL,
    ADD_POST_PULL_REQUEST_PROPOSER_ID_SQL,
